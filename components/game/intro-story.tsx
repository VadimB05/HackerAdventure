    ...
    if (!hasShownIntro) {
      const introStory = {
        ...
        content: [
          ...
          "Du bist NOVA, ein Hacker mit einer verborgenen Vergangenheit. Einst Teil eines geheimen Regierungsprojekts, lebst du nun im Schatten, unter falscher Identität.",
