-- Alarm-Level System Test Script (Vereinfacht)
-- Ohne Foreign Key Constraints für bessere Kompatibilität
...
-- Alarm-Level-Historie Tabelle erstellen (vereinfacht, ohne FK-Constraints)
DROP TABLE IF EXISTS alarm_level_history;
